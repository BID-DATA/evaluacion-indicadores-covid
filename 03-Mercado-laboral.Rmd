...
```{r merTab, fig.cap="Fuente SCLData", echo=FALSE, warning=FALSE, show_col_types = FALSE}
  ...
  DT::datatable(., rownames = FALSE, 
   ...
   DT::formatRound(table = ., columns = c('Tasa de participación', 'Tasa de ocupación', 'Tasa desocupación', 'Población salario lab suficiente', 'duración desempleo'), digits = 2, interval = 2) %>%
